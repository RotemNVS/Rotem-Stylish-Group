<?php  global $Revo_class,$post;
$terms = get_the_terms($post->ID, 'portfolio_categories');
?>
<div class="thumbnail no-border no-padding">
    <div class="media">
        <img src="<?php $Revo_class->get_post_thumbnail(get_the_ID(), 600, 400); ?>"
             alt="<?php the_title(); ?>">
            ...
            <div class="caption-wrapper div-table">
                <div class="caption-inner div-cell">
                    <p class="caption-buttons">
                        <a href="<?php $Revo_class->get_post_thumbnail(get_the_ID(), 600, 400, true); ?>"
    ...
    <div class="caption">
        <h3 class="caption-title"><a href="<?php  echo esc_url(get_the_permalink()); ?>"><?php the_title(); ?></a></h3>
